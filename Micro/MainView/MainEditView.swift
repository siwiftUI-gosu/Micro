    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 0) {
                ...
                CustomButton(
                    title: viewModel.state.btnTitle,
                    foregroundColor: viewModel.state.btnForegroundColor,
                    backgroundColor: viewModel.state.btnBackgroundColor,
                    borderColor: viewModel.state.btnBorderColor,
            ...
            .navigationDestination(isPresented: $viewModel.isPresentDetailView) {
                BookDetailView(
                    viewModel: BookViewModel(book: viewModel.writingBook),
                    mainViewModel: viewModel,
                    mainTabViewSelectedIndex: .constant(0)
                )
                .onDisappear {
